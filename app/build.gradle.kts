...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "LLM_VISION_BASE_URL", "\"${readConfig("LLM_VISION_BASE_URL").gradleEscaped()}\"")
        buildConfigField("String", "LLM_VISION_API_KEY", "\"${readConfig("LLM_VISION_API_KEY").gradleEscaped()}\"")
        buildConfigField("String", "LLM_VISION_MODEL", "\"${readConfig("LLM_VISION_MODEL").gradleEscaped()}\"")
        buildConfigField("String", "LLM_VISION_PATH", "\"${readConfig("LLM_VISION_PATH").ifBlank { "/responses" }.gradleEscaped()}\"")
